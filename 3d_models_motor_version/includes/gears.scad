...
// START Motor gear
		union() 
		{
			...
			translate([0, 0, 30]) 
			{
				...
				difference()
				{
					cylinder(d1=22, d2=22, h=8);

// START Holes for the bolts
					translate([6.3,0,-1])
					cylinder(d=2, h=10, $fs = 0.5);
...
// END Holes for the bolts
					...
					// This is for fitting the motor join with the gear
					translate([0, 0, 6])
					cylinder(d=17.4, h=10, $fs = 0.5);
				}
			}
		}
	}
