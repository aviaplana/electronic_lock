...
void setup()
{
  ...
  ref1 = ADCTouch.read(A2, 500);      //account for the capacitance of the pad
}

void loop()
{
  int value0 = ADCTouch.read(A3);   //no second parameter
  int value1 = ADCTouch.read(A2);     //   --> 100 samples
